  ...
  <div class="twitercontainer">
        ...
        <section id="center__area">
            ...
            <div class="box" >
                ...
                <h4>here is the current  notifications you must wana see !</h4>
            </div>
                <div class="tweet">
                    <form action="">
                    <a href="{{Route('notifications.page')}}" class="notification btn"><span>Inbox</span><span class="badge">1</span>
                     </a>
                      </form>
                      <div class="box__img">
                     <div class="img"></div>
